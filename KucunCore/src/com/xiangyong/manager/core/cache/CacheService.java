...
public interface CacheService {
    ...
    long removeSetMemeber(String key, String[] values);
    ...
    void setObjectWithJsonFormat(String key, Object value);
     ...
     */
    void setObjectWithJsonFormat(String key, Object value, long timeout);

    void setObject(String key, Object value, long timeout);

    <T> T getObject(String key);

    <T> T getObjectFromJsonFormat(String key,Class<T> clazz);
